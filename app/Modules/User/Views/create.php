            ...
            <div class="mb-8">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div class="flex items-center gap-4">
                        <div
                            class="w-12 h-12 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-xl flex items-center justify-center text-white text-xl">
                            👤
                        </div>
                        <div>
            ...
            <form method="POST" class="space-y-8" x-data="userForm()">
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="nome" id="nome" x-model="formData.nome"
                                value="<?= htmlspecialchars($old['nome'] ?? '') ?>" required minlength="2"
                                maxlength="100"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input :type="showPassword ? 'text' : 'password'" name="senha" id="senha"
                                    x-model="formData.senha" required minlength="6"
                            ...
                            <div class="flex justify-between items-center mt-1">
                                ...
                                <p class="text-xs"
                                    ...
                                    x-text="`${formData.senha.length}/∞ caracteres`"></p>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="papel" id="papel"
                                    ...
                                    <option value="editor" <?= ($old['papel'] ?? 'editor') === 'editor' ? 'selected' : '' ?>>
                                        ✏️ Editor
                                    </option>
                ...
                <div class="bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl p-6 border border-amber-200">
                    <h2 class="text-xl font-semibold text-gray-800 mb-4 flex items-center gap-3">
                        <span
                            class="w-8 h-8 bg-amber-500 rounded-lg flex items-center justify-center text-white text-sm">
                            💡
                        </span>
                ...
                <div class="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 border-t border-gray-200">
                    ...
                    <button type="submit"
                        class="bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white px-8 py-3.5 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-0.5 flex items-center gap-3 font-semibold focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 min-w-[180px] justify-center">
