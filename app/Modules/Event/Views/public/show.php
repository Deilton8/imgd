...
<section class="relative bg-gradient-to-br from-yellow-900 via-yellow-800 to-yellow-700 py-20 text-white">
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="max-w-4xl mx-auto text-center">
            <h1 class="text-4xl md:text-6xl font-bold mb-6 leading-tight"><?= htmlspecialchars($evento['titulo']) ?>
            </h1>
        </div>
    </div>
</section>
    ...
    <div class="container mx-auto px-4">
        <ol class="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <li class="flex items-center">
                ...
                <a href="/eventos" class="hover:text-yellow-600 transition-colors duration-200">Eventos</a>
            </li>
            <li class="flex items-center">
                <i class="fas fa-chevron-right text-gray-400 text-xs mx-2"></i>
                <span class="text-gray-900 font-medium"><?= htmlspecialchars($evento['titulo']) ?></span>
            </li>
        </ol>
    </div>
</nav>
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid lg:grid-cols-3 gap-8 mb-12">
                ...
                <div class="lg:col-span-3">
                    <div
                        class="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 shadow-lg border border-gray-100">
                        <!-- Event Info Cards -->
                        <div class="grid md:grid-cols-2 gap-6 mb-8">
                            <div
                                ...
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        <h3 class="font-semibold text-gray-900">Data</h3>
                                        <p class="text-gray-700 font-medium">
                                            Início:
                                            <?= date("d \\d\\e F \\d\\e Y", strtotime($evento['data_inicio'])) ?>
                                        </p>
                                        <p class="text-gray-700 font-medium">
                                            FIm: <?= date("d \\d\\e F \\d\\e Y", strtotime($evento['data_fim'])) ?>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-700 font-medium"><?= htmlspecialchars($evento['local']) ?>
                                        </p>
                                    </div>
                                </div>
                            </div>
            ...
            <?php if (!empty($evento['midias'])): ?>
                ...
                <div x-data="mediaPreview(<?= htmlspecialchars(json_encode($evento['midias'])) ?>)" x-init="init()" x-cloak>
                    <div class="text-center mb-12">
                        ...
                        <p class="text-gray-600 text-lg">Explore as fotos, vídeos e materiais deste evento</p>
                            ...
                            <section id="section-<?= $tipo ?>" class="scroll-mt-8">
                                ...
                                <div class="flex items-center justify-between mb-8">
                                    <div class="flex items-center space-x-4">
                                        <div
                                            class="w-12 h-12 bg-gradient-to-br <?= $cores[$tipo] ?> rounded-xl flex items-center justify-center shadow-lg">
                                    ...
                                    <div class="w-16 h-1 bg-gradient-to-r <?= $cores[$tipo] ?> rounded-full"></div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                    <?php foreach ($midias as $m): ?>
                                        <?php
                                        $index = array_search($m, $evento['midias']);
                                        ...
                                        <div class="group relative cursor-pointer transform hover:-translate-y-2 transition-all duration-300"
                                            ...
                                            <div class="relative overflow-hidden rounded-2xl shadow-lg border border-gray-200">
                                                ...
                                                <div class="relative h-full overflow-hidden">
                                                    <?php if ($tipo === 'imagem'): ?>
                                                        <img src="/<?= $thumbnail ?>"
                                                            alt="<?= htmlspecialchars($m['descricao'] ?? 'Arquivo do evento ' . $evento['titulo']) ?>"
                                                    ...
                                                    <?php elseif ($tipo !== 'imagem' && $tipo !== 'video'): ?>
                    ...
                    <!-- Enhanced Modal (mantido do código anterior) -->
                                ...
                                <div class="w-full h-150 flex items-center justify-center">
                                    <template x-if="current().tipo_arquivo === 'imagem'">
                                        <img :src="'/' + current().caminho_arquivo"
                                            ...
                                            :alt="current().descricao || 'Imagem do evento'">
                                    </template>
                                        ...
                                        <div class="bg-white rounded-2xl p-8 shadow-2xl max-w-md w-full">
                                            <div class="text-center mb-6">
                                                ...
                                                <h3 class="text-xl font-bold text-gray-900"
                                                    x-text="current().descricao || 'Áudio do Evento'"></h3>
                                            </div>
