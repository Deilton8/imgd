...
<section
    class="relative bg-gradient-to-br from-yellow-800 via-yellow-700 to-yellow-600 py-20 text-white overflow-hidden"
    role="banner">
    <!-- Background pattern -->
        ...
        <div class="max-w-5xl mx-auto">
            ...
            <div class="space-y-6">
                <div class="inline-flex items-center space-x-3 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full">
                    ...
                    <span class="text-sm font-semibold">Evento Especial</span>
                </div>
                ...
                <div class="flex flex-wrap gap-4 items-center">
                    <div class="flex items-center text-yellow-100">
                        ...
                        <span class="font-medium"><?= date("d/m/Y", strtotime($evento['data_inicio'])) ?></span>
                    </div>
                    <div class="flex items-center text-yellow-100">
                        <i class="fas fa-map-marker-alt mr-2"></i>
                        <span class="font-medium"><?= htmlspecialchars($evento['local']) ?></span>
                    </div>
                    <?php
                    ...
                    <div class="ml-auto">
                        <?php if ($isToday): ?>
                            <span
                                class="inline-flex items-center px-4 py-2 rounded-full text-sm font-bold text-white bg-gradient-to-r from-green-500 to-green-600 shadow-lg animate-pulse">
                                <i class="fas fa-bell mr-2"></i>
                                ACONTECENDO HOJE
                            </span>
                        <?php elseif ($isUpcoming): ?>
                            <span
                                class="inline-flex items-center px-4 py-2 rounded-full text-sm font-bold text-white bg-gradient-to-r from-blue-500 to-blue-600 shadow-lg">
                                <i class="fas fa-clock mr-2"></i>
                                EM BREVE
                            </span>
                        <?php else: ?>
                            <span
                                class="inline-flex items-center px-4 py-2 rounded-full text-sm font-bold text-white bg-gradient-to-r from-gray-600 to-gray-700 shadow-lg">
        ...
        <ol class="flex flex-wrap items-center gap-x-3 gap-y-2 text-sm">
            ...
            <li class="flex items-center">
                <a href="/eventos"
                    ...
                    <div
                        class="w-8 h-8 bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-lg flex items-center justify-center mr-2 group-hover:scale-110 transition-transform shrink-0">
                        <i class="fas fa-calendar text-yellow-500 text-sm"></i>
                    </div>
            ...
            <li class="min-w-0 flex-1">
                <span class="text-gray-900 font-semibold flex items-center min-w-0">
                    ...
                    <span class="truncate"><?= htmlspecialchars($evento['titulo']) ?></span>
                </span>
            </li>
        </ol>
    </div>
                        ...
                        <div class="bg-gradient-to-r from-yellow-50 to-yellow-100 border-b border-yellow-200 px-8 py-6">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">Detalhes e informações importantes</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div
                            ...
                            <div class="flex items-start space-x-4 mb-4">
                                ...
                                <div>
                                    <h3 class="text-xl font-bold text-gray-900">Data e Hora</h3>
                                    <p class="text-gray-500 text-sm">Quando acontecerá</p>
                                </div>
                            </div>

                            <div class="space-y-3">
                                <div class="flex items-center text-gray-700">
                                    <i class="fas fa-play text-yellow-500 mr-3"></i>
                                    <div>
                                        <div class="font-semibold">Início</div>
                                        <div class="text-lg font-bold text-gray-900">
                                            <?= date("d \\d\\e F \\d\\e Y", strtotime($evento['data_inicio'])) ?>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <?php if (!empty($evento['data_fim'])): ?>
                                    <div class="flex items-center text-gray-700">
                                        <i class="fas fa-flag-checkered text-yellow-500 mr-3"></i>
                                        <div>
                                            <div class="font-semibold">Término</div>
                                            <div class="text-lg font-bold text-gray-900">
                                                <?= date("d \\d\\e F \\d\\e Y", strtotime($evento['data_fim'])) ?>
                                            </div>
                                        </div>
                                    </div>
                                <?php endif; ?>
                        ...
                        <div
                            ...
                            <div class="flex items-start space-x-4 mb-4">
                                <div
                                    class="w-12 h-12 bg-gradient-to-br from-yellow-100 to-yellow-200 rounded-xl flex items-center justify-center flex-shrink-0">
                                    <i class="fas fa-map-marked-alt text-yellow-600 text-lg"></i>
                                </div>
                                <div>
                                    <h3 class="text-xl font-bold text-gray-900">Localização</h3>
                                    <p class="text-gray-500 text-sm">Onde acontecerá</p>
                                </div>
                            </div>

                            <div class="space-y-3">
                                <div class="flex items-start text-gray-700">
                                    <i class="fas fa-map-pin text-yellow-500 mr-3 mt-1"></i>
                                    <div>
                                        <div class="font-semibold mb-1">Local</div>
                                        <div class="text-lg font-bold text-gray-900">
                                ...
                                <!-- Action button for maps -->
                                <a href="https://maps.google.com/?q=<?= urlencode($evento['local']) ?>" target="_blank"
                                    ...
                                    <i
                                        class="fas fa-directions mr-3 group-hover/maplink:scale-110 transition-transform"></i>
            ...
            <?php if (!empty($evento['midias'])): ?>
                ...
                <div class="mt-16 pt-16 border-t border-gray-200">
                    <div class="text-center mb-12">
                        ...
                        <h2 class="text-3xl font-bold text-gray-900 mb-4">Galeria do Evento</h2>
                        <p class="text-lg text-gray-600 max-w-2xl mx-auto">
                            Reviva os melhores momentos através das fotos, vídeos e materiais deste evento especial
                        </p>
                    </div>
                    ...
                    <div x-data="enhancedMediaGallery(<?= htmlspecialchars(json_encode($evento['midias'])) ?>)">
                        <!-- Media Grid -->
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6" id="media-grid">
                            <?php foreach ($evento['midias'] as $index => $m): ?>
                                        ...
                                        <div class="absolute inset-0 bg-gray-100 flex items-center justify-center">
                                            <?php if ($m['tipo_arquivo'] === 'imagem'): ?>
                                                <img src="/<?= $m['caminho_arquivo'] ?>"
                                                    alt="<?= htmlspecialchars($m['descricao'] ?? $evento['titulo']) ?>"
                        ...
                        <!-- Transparent & Attractive Fullscreen Modal -->
                        <div x-show="isOpen" x-transition:enter="transition ease-out duration-300"
                            ...
                            <div class="absolute inset-0 flex items-center justify-center p-4">
                                ...
                                <!-- Image Preview with Enhanced Effects -->
                                    ...
                                    <div class="relative group max-w-5xl max-h-[85vh]">
                                        ...
                                        <div class="relative">
                                            ...
                                            <img :src="'/' + currentItem.caminho_arquivo"
                                                :alt="currentItem.descricao || 'Imagem do evento'"
                                        ...
                                        <div
                                            ...
                                            <div class="bg-black/50 backdrop-blur-sm rounded-lg p-3 text-white text-sm">
                                                <div class="flex items-center justify-between">
                                                    <span x-text="currentItem.descricao || 'Imagem'"></span>
                                                    <span class="text-gray-300" x-text="currentItem.tipo_mime"></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <template x-if="currentItem.tipo_arquivo === 'video'">
                                    <div class="relative group max-w-4xl w-full">
                                        ...
                                        <div class="absolute -bottom-12 left-0 right-0 text-center">
                                            <div
                                                class="inline-flex items-center space-x-4 bg-black/40 backdrop-blur-sm rounded-full px-4 py-2">
                                                <span class="text-white text-sm"
                                                    x-text="currentItem.descricao || 'Vídeo'"></span>
                                                <span class="text-gray-300 text-xs" x-text="currentItem.tipo_mime"></span>
                                            </div>
                                        </div>
                                    </div>
                                </template>

                                <!-- Audio Preview - Floating Card -->
                                    ...
                                    <div
                                        ...
                                        <div class="text-center mb-6">
                                            ...
                                            <h3 class="text-xl font-semibold text-white mb-2"
                                                x-text="currentItem.descricao || 'Áudio do Evento'"></h3>
                                        ...
                                        <div class="flex justify-center space-x-4 mt-6">
                                            <button @click="$refs.audioPlayer.play()"
                                                class="px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white rounded-lg transition-all duration-300 transform hover:scale-105">
                                ...
                                <template x-if="!['imagem','video','audio','pdf'].includes(currentItem.tipo_arquivo)">
                                    <div
                                        ...
                                        <p class="text-gray-500 text-sm mb-6">Este arquivo não pode ser visualizado
                                            diretamente</p>
