...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-indigo-50/30 py-8 px-4 sm:px-6 lg:px-8" x-data="sermonView()"
    x-cloak>
    <div class="max-w-6xl mx-auto">
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        <div class="flex items-center gap-3 mb-2">
                            <h1 class="text-3xl font-bold text-gray-900">Detalhes do Sermão</h1>
                            <span
                                class="px-3 py-1 rounded-full text-xs font-semibold bg-gradient-to-r from-indigo-500 to-purple-500 text-white">
                                ID: <?= $sermao['id'] ?>
                            </span>
                        </div>
                        <p class="text-gray-600">Visualize todas as informações do sermão</p>
                    </div>
                </div>
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div class="flex items-center gap-4">
                        ...
                        <div class="text-sm text-gray-600">
                            <span class="font-medium"><?= htmlspecialchars($sermao['titulo']) ?></span>
                        </div>
                    </div>

                    <div class="flex items-center gap-4">
                        <div class="text-sm text-gray-500">
                            Criado em: <?= date('d/m/Y H:i', strtotime($sermao['criado_em'])) ?>
                        </div>
                        <?php if (!empty($sermao['atualizado_em'])): ?>
                            <div class="text-sm text-gray-500">
                                Atualizado: <?= date('d/m/Y H:i', strtotime($sermao['atualizado_em'])) ?>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <!-- Coluna 1: Informações do Sermão -->
            <div class="lg:col-span-2 space-y-8">
                ...
                <div class="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mb-6">
                            ...
                            <p class="text-gray-700 text-lg"><?= htmlspecialchars($sermao['titulo']) ?></p>
                        </div>
                        ...
                        <?php if (!empty($sermao['pregador'])): ?>
                            <div class="mb-6">
                                ...
                                <p class="text-gray-700"><?= htmlspecialchars($sermao['pregador']) ?></p>
                            </div>
                        <?php endif; ?>

                        <!-- Descrição -->
                        <?php if (!empty($sermao['conteudo'])): ?>
                            <div class="mb-6">
                                <h3 class="text-lg font-bold text-gray-900 mb-2 flex items-center gap-2">
                                ...
                                <div
                                    class="prose prose-lg max-w-none text-gray-700 whitespace-pre-line bg-gray-50 rounded-xl p-6 border border-gray-200">
                                    <?= htmlspecialchars($sermao['conteudo']) ?>
                                </div>
                            </div>
                        <?php endif; ?>
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-2">
                                <span class="text-sm text-gray-600">Pregação:</span>
                ...
                <?php if (!empty($sermao['midias'])): ?>
                    <div x-data="mediaGallery(<?= htmlspecialchars(json_encode($sermao['midias'])) ?>)"
                        ...
                        <div class="bg-gradient-to-r from-purple-600 to-pink-700 px-6 py-4">
                            <div class="flex items-center justify-between">
                                <h2 class="text-xl font-bold text-white">Mídias do Sermão</h2>
            ...
            <div class="space-y-8">
                ...
                <div class="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
                    <div class="bg-gradient-to-r from-amber-500 to-orange-600 px-6 py-4">
                        <h2 class="text-xl font-bold text-white">Status do Sermão</h2>
                    </div>
                        ...
                        <div class="text-center">
                            <div :class="getStatusClasses('<?= $sermao['status'] ?>')"
                                ...
                                <span class="text-lg font-bold"
                                    x-text="getStatusText('<?= $sermao['status'] ?>')"></span>
                            </div>

                            <p class="text-sm text-gray-600 mb-4"
                                x-text="getStatusDescription('<?= $sermao['status'] ?>')"></p>
                        ...
                        <div class="space-y-3">
                            <a href="/admin/sermao/<?= $sermao['id'] ?>/editar"
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="font-semibold text-gray-900">Editar Sermão</p>
                            ...
                            <button @click="showDeleteModal = true"
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="font-semibold text-red-900">Excluir Sermão</p>
            ...
            <div class="relative bg-white rounded-2xl shadow-2xl max-w-md w-full p-6">
                <div class="text-center">
                    ...
                    <p class="text-gray-600 mb-1">
                        <strong class="font-semibold"><?= htmlspecialchars($sermao['titulo']) ?></strong>
                    </p>
                    ...
                    <div class="flex justify-center gap-3">
                        ...
                        <a href="/admin/sermao/<?= $sermao['id'] ?>/deletar"
