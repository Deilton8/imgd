...
<style>
    ...
    @media (max-width: 640px) {
        ...
        /* Ajuste do container para melhor espaçamento */
        ...
        /* Ajuste do sidebar para telas muito pequenas */
        #sidebar-menu {
            width: 85vw;
            max-width: 300px;
        }

        /* Ajuste do padding interno do sidebar */
        #sidebar-menu .p-6 {
            padding: 1.25rem;
        }

        /* Ajuste dos itens do menu para melhor toque */
        ...
        /* Ajuste do submenu mobile */
        #mobile-sobre-menu {
            margin-left: 3rem;
            padding: 0.75rem;
        }

        /* Ajuste dos itens do submenu */
        #mobile-sobre-menu a {
        ...
        /* Ajuste do logo para telas muito pequenas */
        .header-logo img.md\:hidden {
            height: 5rem;
            max-width: 100px;
        }
        ...
        /* Melhorar área de toque para todos os botões interativos */
        button,
        a[role="menuitem"] {
            min-height: 44px;
            min-width: 44px;
    ...
    /* Ajustes para tablets (641px a 768px) */
