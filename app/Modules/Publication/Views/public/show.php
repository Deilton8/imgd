        ...
        <ol class="flex flex-wrap items-center gap-y-2 text-sm">
            ...
            <li class="flex items-center shrink-0">
                <a href="/blog"
                    ...
                    <span class="font-medium hidden sm:inline">Publicações</span>
                </a>
                <div class="text-gray-400 ml-3">
                    <i class="fas fa-chevron-right text-xs mr-4"></i>
                </div>
            ...
            <li class="min-w-0 flex-1">
                <div class="flex items-center min-w-0">
                    <span class="text-gray-900 font-semibold truncate flex items-center min-w-0">
                        <i class="fas fa-star text-yellow-500 mr-2 shrink-0"></i>
                        <span class="truncate"><?= htmlspecialchars($publicacao['titulo']) ?></span>
                    </span>
                </div>
            </li>
        </ol>
